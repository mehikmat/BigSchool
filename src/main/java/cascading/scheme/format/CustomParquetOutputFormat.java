        ...
        private class RecordWriterWrapper implements RecordWriter<java.lang.Void, V> {
                ...
                public void close(Reporter reporter) throws IOException {
                        try {
                                ...
                                FileSystem fileSystem = ofile.getFileSystem(new Configuration());
                                if (r == 0) {
                                        // delete part generated by this task if part size is zero
                                        if (ofile != null) {
                                                fileSystem.delete(ofile, true);
                                                System.out.println("deleted empty part: " + ofile.toString());
                                        }
                                }
                        } catch (InterruptedException e) {
                                Thread.interrupted();
