 ...
 */
public class YarnAppMasterAsync implements AMRMClientAsync.CallbackHandler {
    Configuration configuration;
    NMClient nmClient;
    String command;
    int numContainersToWaitFor;

    public YarnAppMasterAsync(String command, int numContainersToWaitFor) {
    ...
    public static void main(String[] args) throws Exception {
        ...
        YarnAppMasterAsync master = new YarnAppMasterAsync(command, n);
        master.runMainLoop();
